...
class CompanyProcessor(BaseProcessor):
    ...
    def get_company_details(self, company_soup):
        '''
        '''
    ...
    def process_companies(self, companies_df):
        '''
        '''
        processed_companies = []
        try:
    ...
    def main(self):
        ...
        try:
            ...
            companies_to_process = all_companies[~all_companies['company_name'].isin(existing_companies['company_name'])]
            ...
            length = len(companies_to_process)
            ...
            for c, batch_start in enumerate(range(0, length, batch_size)):
                ...
                batch = companies_to_process.iloc[batch_start:batch_start + batch_size]
